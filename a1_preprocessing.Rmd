...
merge_df <- merge(df, token_train, by = c("SUBJ", "VISIT"), all = T)
...
```{r}
df <- merge_df %>% 
    select(SUBJ, VISIT, Diagnosis, Ethnicity, Gender, Age, ADOS, MullenRaw, ExpressiveLangRaw, Socialization, MOT_MLU, CHI_MLU, types_MOT.x, types_MOT.y, types_CHI.x, types_CHI.y, tokens_MOT.x, tokens_MOT.y, tokens_CHI.x, tokens_CHI.y)
